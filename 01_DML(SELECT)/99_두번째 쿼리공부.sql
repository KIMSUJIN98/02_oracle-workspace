...
-- OR SUBSTR을 이용한 강제 출력
SELECT SUBSTR(TO_CHAR(TO_DATE('210908'), 'YYYY"년 "MM"월" DD"일"'), 1, 6)
|| SUBSTR(TO_CHAR(TO_DATE('210908'), 'YYYY"년 "MM"월" DD"일"'), 8, 3)
|| SUBSTR(TO_CHAR(TO_DATE('210908'), 'YYYY"년 "MM"월" DD"일"'), 12, 2)
FROM DUAL;
